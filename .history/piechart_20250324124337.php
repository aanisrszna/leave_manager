...
<script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var leaveCountsAnnual = <?php echo json_encode($leaveCountsAnnual); ?>;
            var leaveCountsMedical = <?php echo json_encode($leaveCountsMedical); ?>;
            ...
            // Destroy existing chart if it exists (to prevent old color issues)
            let existingChart = Chart.getChart("approvedLeaveBarChart");
            if (existingChart) {
                    ...
                    datasets: [
                        {
                            label: 'Annual Leave',
                            data: leaveCountsAnnual,
                            backgroundColor: '#4CAF50', // Green for Annual Leave
                            borderWidth: 1
                        },
                        {
                            label: 'Medical Leave',
