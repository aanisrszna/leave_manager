...
// Display the combined leave count table
echo "<h3>Employee Leave Count</h3>";
echo "<table border='1'>";
echo "<tr><th>Employee Name</th><th>Annual Leave</th><th>Medical Leave</th></tr>";

// Create an associative array to store merged leave counts
$leaveData = [];

// Merge annual leave data
// foreach ($resultsAnnual as $row) {
//     $leaveData[$row['FirstName']]['Annual'] = $row['leave_count'];
//     $leaveData[$row['FirstName']]['Medical'] = 0; // Default to 0 if no medical leave
// }

// // Merge medical leave data
// foreach ($resultsMedical as $row) {
//     if (isset($leaveData[$row['FirstName']])) {
//         $leaveData[$row['FirstName']]['Medical'] = $row['leave_count'];
//     } else {
//         $leaveData[$row['FirstName']]['Annual'] = 0; // Default to 0 if no annual leave
//         $leaveData[$row['FirstName']]['Medical'] = $row['leave_count'];
//     }
// }

// // Print the leave data in the table
// foreach ($leaveData as $name => $leaves) {
//     echo "<tr><td>{$name}</td><td>{$leaves['Annual']}</td><td>{$leaves['Medical']}</td></tr>";
// }

// echo "</table>";

// Print resultAnnual and resultMedical below the table
echo "<h3>Result Annual</h3>";
echo "<pre>";
print_r($resultsAnnual);
echo "</pre>";

echo "<h3>Result Medical</h3>";
echo "<pre>";
print_r($resultsMedical);
echo "</pre>";
