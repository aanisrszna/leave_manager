...
<div class="text-center">
    <div class="d-flex align-items-center justify-content-center">
        <button type="button" class="btn btn-outline-primary mx-2 change-month" data-month="<?= $previousMonth ?>">&lt;</button>
        <h5 id="current-month" class="mb-0"><?= date("F", mktime(0, 0, 0, $currentMonth, 1, $currentYear)) ?> <?= $currentYear ?></h5>
        <button type="button" class="btn btn-outline-primary mx-2 change-month" data-month="<?= $nextMonth ?>">&gt;</button>
    </div>
</div>
