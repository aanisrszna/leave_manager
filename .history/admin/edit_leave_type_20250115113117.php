                            ...
                            <section>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- Add 'required' to ensure one of them is selected -->
                                        <input name="needproof" type="radio" value="yes" <?php echo ($row['NeedProof'] == 1) ? 'checked' : ''; ?> required> Yes
                                        <input name="needproof" type="radio" value="no" <?php echo ($row['NeedProof'] == 0) ? 'checked' : ''; ?> required> No
                                    </div>
