...
if (isset($_POST['edit'])) {
    ...
    $stmt->bind_param("ssii", $leavetype, $description, $assigned_day, $get_id);
                            ...
                            <section>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="available_Day" type="number" class="form-control" min="1" value="<?php echo htmlentities($row['assigned_day']); ?>" required>
                                    </div>
