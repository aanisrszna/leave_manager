...
if (isset($_POST['add_staff'])) {
    ...
    if ($count > 0) {
        ...
        $sql = "INSERT INTO tblemployees (
            FirstName, EmailId, Password, Gender, Dob, Department, Address, role, Phonenumber, Status, location, Staff_ID, Position_Staff
        ) VALUES (
            '$fname', '$email', '$password', '$gender', '$dob', '$department', '$address', '$user_role', '$phonenumber', '$status', 'NO-IMAGE-AVAILABLE.jpg', '$staff_id', '$position_staff'
        )";
