...
if (isset($_POST['add_staff'])) {
    ...
    // Auto-generate DOB from IC number (assuming Malaysian IC format YYYYMMDD-XX-XXXX)
    if (preg_match('/^(\d{2})(\d{2})(\d{2})-\d{2}-\d{4}$/', $ic_number, $matches)) {
        $year = $matches[1] < 50 ? '20' . $matches[1] : '19' . $matches[1];
        $dob = "$year-$matches[2]-$matches[3]";
    }
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="date_joined" type="text" class="form-control date-picker" required autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="ic_number" type="text" class="form-control" required autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <label>Service Year:</label>
                                            <input name="service_year" type="text" class="form-control" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
