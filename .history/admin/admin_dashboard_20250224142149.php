                            ...
                            <div class='card-box height-100-p widget-style3'>
                                <div class='d-flex justify-content-center align-items-center' style='background-color:rgb(70, 142, 209); color: white; padding: 10px;'>
                                    <h3 class='h4 mb-0' style='font-weight: 600;'>
                                        <a href="edit_staff.php?edit=<?php echo urlencode($employee->emp_id); ?>" style="color: white; text-decoration: none;">
                                            <?php echo htmlentities($employee->FirstName) . " (Staff ID: " . htmlentities($employee->emp_id) . ")"; ?>
                                        </a>
                                    </h3>
                                </div>
