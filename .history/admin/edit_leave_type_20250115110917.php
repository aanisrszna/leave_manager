...
if (isset($_POST['edit'])) {
    ...
    $needproof = isset($_POST['needproof']) ? 1 : 0; // Handle NeedProof as a boolean (1 or 0)
                            ...
                            <section>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="needproof" type="checkbox" <?php echo ($row['NeedProof'] == 1) ? 'checked' : ''; ?>>
                                        <small>Check if proof is needed for this leave type</small>
                                    </div>
