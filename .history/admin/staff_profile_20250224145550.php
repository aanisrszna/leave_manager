                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr><th>Email:</th><td><?php echo htmlentities($employee['Email']); ?></td></tr>
                                    ...
                                    <tr><th>Position:</th><td><?php echo htmlentities($employee['Position']); ?></td></tr>
                                    <tr><th>Hire Date:</th><td><?php echo htmlentities($employee['HireDate']); ?></td></tr>
                                    <tr><th>Profile Picture:</th>
                                        <td>
                                            <img src="uploads/<?php echo htmlentities($employee['ProfileImage']); ?>" width="100" height="100" alt="Profile">
                                        </td>
                                    </tr>
                                </table>
                            </div>
