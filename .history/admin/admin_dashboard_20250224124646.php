        ...
        <div class="pd-ltr-20">
            ...
            <div class="row pb-0">
                ...
                foreach ($employees as $employee) {
                    echo "<div class='col-xl-6 col-lg-6 col-md-12 mb-20'> <!-- Adjusted for two columns -->
                            <div class='card-box height-100-p widget-style3'>
                                <div class='d-flex justify-content-center align-items-center' style='background-color:rgb(70, 142, 209); color: white; padding: 10px;'>
                                    <h3 class='h4 mb-0' style='font-weight: 600;'>
                                        <a href="<?php echo 'staff_profile.php?emp_id=' . htmlentities($employee->emp_id); ?>" style="color: white; text-decoration: none;">
                                            <?php echo htmlentities($employee->FirstName) . " (Staff ID: " . htmlentities($employee->Staff_ID) . ")"; ?>
                                        </a>
                    ...
                    foreach ($leave_details as $leave) {
                        echo "<tr>
                                <td style='background-color: #f9f9f9;'>" . htmlentities($leave->LeaveType) . "</td>
                                <td style='background-color: #f9f9f9;'>" . htmlentities($leave->available_day) . "</td>
                            </tr>";
                    }
