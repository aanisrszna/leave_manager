                                ...
                                <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <table class="table">
                                                <tr><th>Name:</th><td><?php echo htmlentities($employee['FirstName']); ?></td></tr>
                                                <tr><th>Relation:</th><td><?php echo htmlentities($employee['LastName']); ?></td></tr>
                                                <tr><th>Contact:</th><td><?php echo htmlentities($employee['Staff_ID']); ?></td></tr>
