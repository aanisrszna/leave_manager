...
<div class="main-container">
    <div class="pd-ltr-20">
        ...
        <div class="row pb-10">
            <!-- Widget for total number of staff -->
            ...
            <!-- Widget for total number of coordinators -->
            <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
                <div class="card-box height-100-p widget-style3">
                    <?php
            ...
            <!-- Widget for total number of HODs -->
            <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
                <div class="card-box height-100-p widget-style3">
                    <?php
        ...
        <div class="card-box mb-30">
            ...
            <div class="pb-20">
                <table class="data-table table stripe hover nowrap">
                    ...
                    <tbody>
                        <?php
                        $staff_query = mysqli_query($conn,"SELECT * FROM tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentShortName WHERE role IN ('Director', 'Manager', 'Staff','Admin) ORDER BY tblemployees.emp_id");
