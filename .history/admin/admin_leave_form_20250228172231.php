...
if (isset($_POST['submit'])) {
    ...
    $empQuery = "SELECT emp_id, role FROM tblemployees WHERE Staff_ID = ?";
    ...
    if ($empResult->num_rows > 0) {
        ...
        // Retrieve the name of the leave type from tblleavetype
            ...
            if ($insertStmt) {
                ...
                if ($insertStmt->execute()) {
                    ...
                    if ($emailResult->num_rows > 0) {
                        ...
                        // Send email
                        require 'send_email.php';  // Include the email function file
