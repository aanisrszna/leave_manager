...
if (isset($_POST['edit'])) {
    ...
    // Convert the selected NeedProof option into 1 for 'yes' or 0 for 'no'
    ...
    $stmt->bind_param("ssdid", $leavetype, $description, $assigned_day, $needproof, $get_id); // "d" for decimal, "i" for integer
                            ...
                            <section>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- Use PHP to check the value and pre-select the radio button -->
                                        <input name="needproof" type="radio" value="yes" id="needproof_yes" <?php echo ($row['NeedProof'] == 1) ? 'checked' : ''; ?> required>
                                        <label for="needproof_yes">Yes</label>

                                        <input name="needproof" type="radio" value="no" id="needproof_no" <?php echo ($row['NeedProof'] == 0) ? 'checked' : ''; ?> required>
