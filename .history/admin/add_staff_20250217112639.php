                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="date_joined" type="date" class="form-control date-picker" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="dob" type="date" class="form-control date-picker" required autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
