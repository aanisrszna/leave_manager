...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 10, 'Leave Application Form', 0, 1, 'L');
        $this->SetFont('helvetica', 'I', 10);
        $this->Cell(0, 5, '(This form must be COMPLETED with all details before submission)', 0, 1, 'L');
        $this->Cell(0, 5, '(All forms must be submitted 4 days before the leave date.)', 0, 1, 'L');
        $this->Cell(0, 5, '(Please attach medical certificates for sick leave.)', 0, 1, 'L');
        $this->Ln(5);
