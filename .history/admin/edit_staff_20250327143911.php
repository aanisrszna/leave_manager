...
if (isset($_POST['update_staff'])) {
    ...
    $current_password_row = mysqli_fetch_assoc($current_password_query);
    ...
    if (!empty($password)) {
        ...
        $hashed_password = $current_hashed_password; // Retain old password if no new password provided
    }
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="Password" type="password" class="form-control wizard-required" required autocomplete="off" value="<?php echo $row['Emergency_Name']; ?>">
                                    </div>
                                </div>
                            </div>
