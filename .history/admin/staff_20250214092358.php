        ...
        <div class="card-box mb-30">
            ...
            <div class="pb-20">
                <table class="data-table table stripe hover nowrap">
                    ...
                    <tbody>
                        <?php
                        $staff_query = mysqli_query($conn,"SELECT * FROM tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentShortName WHERE role IN ('Director', 'Manager', 'Staff') ORDER BY tblemployees.emp_id");
