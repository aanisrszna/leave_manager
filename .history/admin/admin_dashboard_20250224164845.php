    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            ...
            <div class="title pb-10">
                <h5 class="mb-2" style="font-size: 18px; font-weight: 600;">Employee Leave Information</h5> <!-- Smaller title with spacing -->
                ...
                <div style="display: flex; gap: 10px; align-items: center; margin-top: 10px;"> <!-- Added margin-top for spacing -->
                    <form class="mb-2" method="POST" action="employee_report.php">
