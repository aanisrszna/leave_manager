...
if (isset($_POST['edit'])) {
    ...
    $available_day = intval($_POST['available_day']); // Ensure available days are numeric

    // Update query using prepared statements
    $stmt = $conn->prepare("UPDATE tblleavetype SET LeaveType = ?, Description = ?, available_day = ? WHERE id = ?");
    $stmt->bind_param("ssii", $leavetype, $description, $available_day, $get_id);
                            ...
                            <section>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="available_Day" type="number" class="form-control" min="1" value="<?php echo htmlentities($row['available_day']); ?>" required>
                                    </div>
