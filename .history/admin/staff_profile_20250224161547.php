        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header text-center">
                    <h3 class="font-weight-bold">Staff Profile</h3>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card text-center p-4">
                                        <div class="card-body">
                                            ...
                                            <h4 class="card-title"> <?php echo htmlentities($employee['FirstName'] . " " . $employee['LastName']); ?> </h4>
                                            ...
                                            <div class="row text-left">
                                                <div class="col-md-6">
                                                    ...
                                                    <p><strong>Phone:</strong> <?php echo htmlentities($employee['Phonenumber']); ?></p>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p><strong>Hire Date:</strong> <?php echo htmlentities($employee['date_joined']); ?></p>
