...
if (isset($_POST['add_staff'])) {
    ...
    if ($count > 0) {
        ...
        $sql = "INSERT INTO tblemployees (
            ...
            '$fname', '$email', '$hashed_password', '$gender', '$dob', '$department', '$address', '$user_role', '$phonenumber', '$status', 'NO-IMAGE-AVAILABLE.jpg', '$staff_id', '$position_staff', '$date_joined', '$emergency_contact', '$car_plate', '$reporting_to', '$ic_number', '$service_year', '$emergency_name', '$emergency_relation'
        )";
