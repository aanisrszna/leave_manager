...
// Fetch approved leave count per employee for the current year
$sql = "SELECT e.FirstName, COUNT(l.id) AS leave_count 
        FROM tblleave l 
        JOIN tblemployees e ON l.empid = e.emp_id 
        WHERE l.RegRemarks = :status AND YEAR(l.leave_date) = :currentYear
...
<div class="card-box height-100-p d-flex flex-column justify-content-center align-items-center">
    <h3>Leave (<?php echo $currentYear; ?>)</h3>
    <div class="pb-20">
        <?php if ($hasData): ?>
