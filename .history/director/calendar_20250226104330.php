...
<div class="calendar-container">
    ...
    // Define holidays (Example: Malaysia Public Holidays 2025)
    $holidays = [
        '2025-01-01' => ['New Year’s Day', 'holiday'],
        '2025-02-01' => ['Federal Territory Day', 'holiday'],
        '2025-02-29' => ['Thaipusam', 'holiday'],
        '2025-04-17' => ['Nuzul Al-Quran', 'holiday'],
        '2025-05-01' => ['Labour Day', 'holiday'],
        '2025-05-17' => ['Wesak Day', 'holiday'],
        '2025-06-07' => ['Agong’s Birthday', 'holiday'],
        '2025-07-30' => ['Hari Raya Aidiladha', 'holiday'],
        '2025-08-31' => ['National Day', 'holiday'],
        '2025-09-16' => ['Malaysia Day', 'holiday'],
        '2025-10-25' => ['Prophet Muhammad’s Birthday', 'holiday'],
        '2025-12-25' => ['Christmas Day', 'holiday'],
    ];

    echo draw_calendar($currentMonth, 2025, $holidays);
    ?>
</div>
