...
<form method="GET" class="mb-4 d-flex align-items-center">
    <button type="submit" name="month" value="<?= isset($_GET['month']) && $_GET['month'] > 1 ? $_GET['month'] - 1 : 12 ?>" class="btn btn-secondary me-2">←</button>
    ...
    <button type="submit" name="month" value="<?= isset($_GET['month']) && $_GET['month'] < 12 ? $_GET['month'] + 1 : 1 ?>" class="btn btn-secondary ms-2">→</button>
    
    <button type="submit" class="btn btn-primary ms-2">Show Calendar</button>
</form>
