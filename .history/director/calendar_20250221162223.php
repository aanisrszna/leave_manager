<?php
include('db_connection.php'); // Ensure you have a connection file
...
function draw_calendar($month, $year, $events) {
    ...
    while ($currentDay <= $numberOfDays) {
        ...
        $tooltip = $eventName ? "<span class='tooltiptext'>$eventName</span>" : "";

        $calendar .= "<td class='text-center $eventClass tooltip'>";
        $calendar .= $currentDay . $tooltip;
        $calendar .= "</td>";
