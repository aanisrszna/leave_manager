...
$selectedYear = 2025; // Fixed year for now
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <a href="?month=<?= $prevMonth ?>" class="btn btn-secondary">&#9665; Prev</a>
    <form method="GET">
        <label for="month">Select Month:</label>
        <select name="month" id="month" class="form-control d-inline-block w-auto" onchange="this.form.submit()">
            <?php
            $months = [
    ...
    <a href="?month=<?= $nextMonth ?>" class="btn btn-secondary">Next &#9655;</a>
</div>

<!-- Calendar Display -->
<div class="calendar-container">
    <?php echo draw_calendar($selectedMonth, $selectedYear, $calendarEvents); ?>
</div>
...
<div class="calendar-container">
    ...
    function draw_calendar($month, $year, $events) {
        ...
        while ($currentDay <= $numberOfDays) {
            ...
            $calendar .= $currentDay;
            if ($eventName) $calendar .= "<br><small>$eventName</small>";
            $calendar .= "</td>";
