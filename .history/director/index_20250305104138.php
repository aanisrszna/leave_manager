...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="row">
				<!-- First Row: Total Staff and Two Pie Charts -->
				...
				<div class="col-xl-4 col-lg-4 mb-20">
					<div class="card-box">
						<h5 class="text-center">Leave Status Overview</h5>
				...
				<div class="col-xl-4 col-lg-4 mb-20">
					<div class="card-box">
						<h5 class="text-center">Departmental Leave Overview</h5>
						<?php include('../department_piechart.php'); ?>
					</div>
				</div>
			</div>

			<!-- Second Row: Approved Leave, Pending Leave, Rejected Leave -->
			<div class="row">
				<div class="col-xl-4 col-lg-4 mb-20">
					<div class="card-box height-100-p widget-style3">
						<?php
						...
						$query->execute();
						$approvedLeave = $query->rowCount();
						?>
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo $approvedLeave; ?></div>
				...
				<div class="col-xl-4 col-lg-4 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						$query->bindParam(':status', $status, PDO::PARAM_STR);
						$query->execute();
						$pendingLeave = $query->rowCount();
						?>
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo $pendingLeave; ?></div>
				...
				<div class="col-xl-4 col-lg-4 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						$query->bindParam(':status', $status, PDO::PARAM_STR);
						$query->execute();
						$rejectedLeave = $query->rowCount();
						?>
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo $rejectedLeave; ?></div>
