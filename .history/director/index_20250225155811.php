								...
								<tr>
									...
									<td>
										...
										if ($row->Role === 'Manager' || $row->Role === 'Admin') {
											...
											echo $row->HodRemarks == 1 ? '<span style="color: green">Approved</span>' :
												 ($row->HodRemarks == 2 ? '<span style="color: red">Rejected</span>' : '<span style="color: blue">Pending</span>');
										}
										?>
									</td>
									<td>
										<?php echo $row->RegRemarks == 1 ? '<span style="color: green">Approved</span>' :
												 ($row->RegRemarks == 2 ? '<span style="color: red">Rejected</span>' : '<span style="color: blue">Pending</span>'); ?>
									</td>
									<td>
