...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Calculate the maximum leave count for Y-axis scaling
        var maxLeaveCount = Math.max(
            ...leaveCountsAnnual.map(Number), 
            ...leaveCountsMedical.map(Number)
        );
            ...
            options: {
                ...
                scales: {
                    ...
                    y: {
                        ...
                        beginAtZero: true,
                        suggestedMax: maxLeaveCount + 1, // Adjust to fit the highest leave count
                        ticks: {
                            stepSize: 1
                        }
                    }
