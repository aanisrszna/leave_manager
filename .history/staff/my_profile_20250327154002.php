...
$query = $conn->prepare("SELECT * FROM tblemployees 
                         LEFT JOIN tbldepartments 
                         ON tblemployees.Department = tbldepartments.DepartmentShortName 
                         WHERE emp_id = ?");
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="department" class="custom-select form-control" required>
                                                            ...
                                                            <?php
                                                            $deptQuery = $conn->query("SELECT * FROM tbldepartments");
