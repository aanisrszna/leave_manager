                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 mb-4">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted">Available Days: <strong><?php echo htmlspecialchars($row['available_day']); ?></strong></p>
                                
                                <!-- Dynamic Progress Bar -->
                                <div class="progress" style="height: 8px;">
                                    <div class="progress-bar bg-success" role="progressbar"
                                         style="width: <?php echo ($row['available_day'] / 30) * 100; ?>%;"
                                         aria-valuenow="<?php echo $row['available_day']; ?>" aria-valuemin="0" aria-valuemax="30">
                                    </div>
                                </div>
                
                                <!-- Action Button -->
                                <a href="apply_leave.php?type=<?php echo urlencode($row['LeaveType']); ?>" class="btn btn-primary btn-sm mt-3">
                                    Apply Leave <i class="fas fa-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
