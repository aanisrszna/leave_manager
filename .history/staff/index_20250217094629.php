    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            ...
            <div class="row pb-10">
                ...
                ?>
                <div class="col-xl-3 col-lg-6 col-md-12 mb-20">
                    <div class="card-box height-100-p widget-style3">
                        <div class="d-flex flex-wrap">
                            <div class="widget-data">
                                <div class="weight-600 font-16 text-dark"><?php echo htmlspecialchars($row['LeaveType']); ?></div>
                                <div class="font-112 text-secondary weight-400">
