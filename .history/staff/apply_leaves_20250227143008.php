...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['apply'])) {
    ...
    $emp_query = "SELECT FirstName, LastName, Department FROM tblemployees WHERE emp_id = ?";
    ...
    if ($overlap_result->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            ...
            if (!empty($hod_email)) {
                $subject = "New Leave Application from $emp_name";
                $message = "
                    <p>Dear Manager,</p>
                ...
                ";
                send_email($hod_email, $subject, $message);
            }
