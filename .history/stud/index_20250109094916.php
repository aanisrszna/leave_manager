	...
	<div class="main-container">
        <div class="pd-ltr-20">
            ...
            <div class="row pb-10">
                ...
                // Fetch leave types and available days for the logged-in user
                $sql = "SELECT el.leave_type_id, lt.leave_type, el.available_day 
                ...
                // Loop through leave types and available days
                if ($query->rowCount() > 0) {
                            ...
                            <div class="card-box height-100-p widget-style3">
                                <div class="d-flex flex-wrap">
                                    <div class="widget-data">
                                        <div class="weight-700 font-24 text-dark"><?php echo htmlentities($result->available_day); ?></div>
                                        <div class="font-14 text-secondary weight-500"><?php echo htmlentities($result->leave_type); ?></div>
                                    </div>
