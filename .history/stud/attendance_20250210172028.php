...
// Set timezone to Asia/Kuala_Lumpur to ensure correct time handling
        ...
        <div class="col-md-6">
            ...
            <table class="table table-striped">
                ...
                <tbody id="attendance-records">
                    <?php if (count($attendance_records) > 0): ?>
                        <?php foreach ($attendance_records as $record): ?>
                            <tr>
                                ...
                                <td><?php echo $record['time_in'] ? 'In' : '-'; ?></td>
                                <td><?php echo $record['time_out'] ?: '-'; ?></td>
                                <td><?php echo $record['time_out'] ? 'Out' : '-'; ?></td>
                                <td>
                                    <?php
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center">No records found for today.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
