                    ...
                    <div class="card-box height-100-p widget-style3">
                        <div class="d-flex flex-wrap">
                            <div class="widget-data">
                                ...
                                <div class="font-14 text-secondary weight-500">Description: <?php echo $row['Description']; ?></div>
                                <div class="font-14 text-secondary weight-500">Available Days: <?php echo $row['available_day']; ?></div>
                            </div>
