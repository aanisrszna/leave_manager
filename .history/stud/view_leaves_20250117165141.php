					...
					<form method="post" action="">
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<div class="avatar mr-2 flex-shrink-0">
									<?php if (!empty($result->ProofPicture)) { ?>
										<img src="<?php echo '../proofs/' . htmlentities($result->ProofPicture); ?>" width="300" height="200" alt="Proof Picture">
									<?php } else { ?>
						...
						<div class="form-group row">
							<div class="col-md-6 col-sm-12">
							    <div class="form-group">
									<label style="font-size:16px;"><b>Date For Managers's Action</b></label>
									<?php
									if ($result->HodDate==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
