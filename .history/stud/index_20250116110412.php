...
<body>
    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            ...
            // When employee logs in, mark notifications as read (is_read = 1)
            $updateNotificationsQuery = mysqli_query($conn, "
                UPDATE tblnotifications 
                SET is_read = 1 
                WHERE empid = '$session_id' AND is_read = 0;
            ") or die(mysqli_error($conn));

            // After marking as read, delete read notifications
            $deleteReadNotificationsQuery = mysqli_query($conn, "
                DELETE FROM tblnotifications 
                WHERE empid = '$session_id' AND is_read = 1;
            ") or die(mysqli_error($conn));
