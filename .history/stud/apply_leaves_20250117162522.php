...
if (isset($_POST['apply'])) {
    ...
    $proofFilePath = null; // Default value for proof file path
    ...
    if (isset($_FILES['proof']) && $_FILES['proof']['error'] === UPLOAD_ERR_OK) {
        ...
        if (!in_array($file['type'], $allowedTypes)) {
            die("<script>alert('Invalid file type. Only JPG, PNG, and PDF are allowed.');</script>");
        }

        // Validate file size
        if ($file['size'] > $maxFileSize) {
            die("<script>alert('File size exceeds 2MB.');</script>");
        }
        ...
        if (move_uploaded_file($file['tmp_name'], $uploadPath)) {
            $proofFilePath = $uploadPath;
        } else {
            die("<script>alert('Error uploading the file.');</script>");
        }
    }
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="j-input j-append-small-btn">
                                                ...
                                                <input type="text" id="proof_input" readonly placeholder="Upload proof for leave">
