...
if (isset($_POST['apply'])) {
    ...
    // Handle file upload
    $target_dir = "proof/"; // Ensure this folder exists and has write permissions
    ...
    if (move_uploaded_file($_FILES["proof"]["tmp_name"], $target_file)) {
        $proof_path = $target_file; // Save the file path for database storage
    } else {
        $proof_path = NULL; // No file uploaded or failed to upload
    ...
    if (mysqli_num_rows($overlap_result) > 0) {
        ...
        $query = "
            INSERT INTO tblleave (empid, LeaveType, FromDate, ToDate, RequestedDays, DaysOutstand, Proof, PostingDate)
            VALUES ('$empid', '$leave_type', '$date_from', '$date_to', '$requested_days', '$outstanding_days', '$proof_path', '$datePosting')
        ";
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="proof" type="file" class="form-control">
                                        </div>
                                    </div>
                                </div>
