					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<div class="profile-photo">
								<img src="<?php echo (!empty($row['location'])) ? '../uploads/'.$row['location'] : '../uploads/NO-IMAGE-AVAILABLE.jpg'; ?>" alt="Profile Photo" class="avatar-photo">
								<form method="post" enctype="multipart/form-data" class="upload-form">
									<div class="form-group">
										<label for="file" class="custom-file-label">Upload Profile Picture</label>
										<input type="file" name="image" id="file" class="custom-file-input" accept="image/*" onchange="validateImage('file')">
									</div>
									<div class="form-group">
