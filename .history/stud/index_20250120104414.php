    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            ...
            <div class="row pb-10">
                ...
                ?>
                <div class="col-xl-4 col-lg-6 col-md-12 mb-20">
            ...
            <div class="calendar-container">
                ...
                // Updated draw_calendar function
                function draw_calendar($month, $year, $events) {
                    ...
                    while ($currentDay <= $numberOfDays) {
                        ...
                        // Merge all classes (if multiple)
                        $mergedClasses = implode(' ', array_unique($eventClasses));

                        $calendar .= "<td class='text-center $mergedClasses'>";
                        $calendar .= $currentDay;

                        if (!empty($eventNames)) {
                            $calendar .= "<br><small>" . implode('<br>', $eventNames) . "</small>";
                        }
