                ...
                .then(data => {
                    ...
                    if (data.length > 0) {
                        data.forEach(record => {
                            ...
                            // Format the times to local format
                            const localTimeIn = timeIn.toLocaleTimeString();
                            const localTimeOut = timeOut ? timeOut.toLocaleTimeString() : '-';
                            const status = record.time_out ? 'Out' : 'In';
