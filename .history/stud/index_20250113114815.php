        ...
        <div class="pd-ltr-20">
            ...
            <div class="calendar-container">
                ...
                while ($row = mysqli_fetch_array($birthdayQuery)) {
                    ...
                    $birthdays[$formattedDate] = $firstname . " Birthday";
                }
                ...
                function draw_calendar($month, $year, $events) {
                    ...
                    while ($currentDay <= $numberOfDays) {
                        ...
                        $eventName = isset($events[$currentDate]) ? $events[$currentDate] : null;
                        $eventClass = isset($birthdays[$currentDate]) ? 'table-info' : (isset($malaysiaHolidays[$currentDate]) ? 'table-danger' : '');

                        $calendar .= "<td class='text-center $eventClass'>";
                        $calendar .= $currentDay;
                        if ($eventName) {
                            $calendar .= "<br><small class='text-muted'>$eventName</small>";
                        }
                        $calendar .= "</td>";
