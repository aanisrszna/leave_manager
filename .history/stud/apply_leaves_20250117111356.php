...
if (isset($_POST["update_image"])) {
    ...
    $result = mysqli_query($conn,"update tblemployees set proof='$proof' where emp_id='$session_id'         
		")or die(mysqli_error());
    if ($result) {
                        ...
                        <form method="post" action="">
                            <section>
                                ...
                                <div class="profile-photo">
                                    ...
                                    <img src="<?php echo (!empty($row['proof'])) ? '../uploads/'.$row['location'] : '../uploads/NO-IMAGE-AVAILABLE.jpg'; ?>" alt="" class="avatar-photo">
