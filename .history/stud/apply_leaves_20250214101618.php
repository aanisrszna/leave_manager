...
<?php include('../includes/email_function.php'); ?>

<?php
include('../includes/config.php');
include('../includes/session.php');
include('../includes/email_function.php'); // ✅ Fix: Correct path to email_function.php
...
if (isset($_POST['apply'])) {
    ...
    if (mysqli_num_rows($overlap_result) > 0) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            $emp_query = "SELECT FullName, EmailId FROM tblemployees WHERE emp_id = '$empid'";
            ...
            if ($employee) {
                ...
                if (sendNotificationStaff($employee_email, $employee_name, $leaveDetails)) {
