...
if (isset($_POST['apply_leave'])) {
    // Retrieve other form inputs if needed
    ...
    // Handle file upload
    if ($proof_file['error'] === 0) {
        // Define upload directory and file information
        $upload_dir = '../uploads/';
        ...
        if (in_array($file_ext, $allowed_extensions) && $proof_file['size'] <= $max_file_size) {
            // Create a unique file name
            $file_name = uniqid('proof_', true) . '.' . $file_ext;

            // Move the uploaded file to the target directory
            if (move_uploaded_file($proof_file['tmp_name'], $upload_dir . $file_name)) {
                // Save leave application to the database
                $query = "INSERT INTO tblleave (leave_type, date_from, date_to, proof) VALUES (?, ?, ?, ?)";
                $stmt = $conn->prepare($query);
                $stmt->bind_param('ssss', $leave_type, $date_from, $date_to, $file_name);
                ...
                echo "Failed to upload the proof file.";
            }
        } else {
            echo "Invalid file type or file size exceeds 2MB.";
        }
    } else {
        // Handle case where no proof is uploaded (optional)
        $query = "INSERT INTO tblleave (leave_type, date_from, date_to) VALUES (?, ?, ?)";
        $stmt = $conn->prepare($query);
        $stmt->bind_param('sss', $leave_type, $date_from, $date_to);
...
if (isset($_POST['apply'])) {
    ...
    if (mysqli_num_rows($overlap_result) > 0) {
        ...
        $query = "
            INSERT INTO tblleave (empid, LeaveType, FromDate, ToDate, RequestedDays, DaysOutstand, PostingDate)
            VALUES ('$empid', '$leave_type', '$date_from', '$date_to', '$requested_days', '$outstanding_days', '$datePosting')
        ";
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div style="margin-left: 30px; margin-right: 30px;" class="pd-20 card-box mb-30">
                    ...
                    <form method="post" enctype="multipart/form-data" action="save_leave.php">
                        <section>
                            <?php
                            if ($role_id === 'Staff') {
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="firstname" type="text" class="form-control" required readonly value="<?php echo $row['FirstName']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="position" type="text" class="form-control" required readonly value="<?php echo $row['Position_Staff']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Staff ID Number</label>
                                        <input name="staff_id" type="text" class="form-control" required readonly value="<?php echo $row['Staff_ID']; ?>">
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="leave_type" id="leave_type" class="form-control" required onchange="updateAvailableDays()">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="date_from" name="date_from" type="date" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>End Leave Date</label>
                                        <input id="date_to" name="date_to" type="date" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select id="is_half_day" name="is_half_day" class="form-control" onchange="toggleHalfDayType()">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="proof_file" id="proof_file" class="form-control-file" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx">
                                        <small class="form-text text-muted">
                                            Accepted file formats: JPG, JPEG, PNG, PDF, DOC, DOCX. Max size: 2MB.
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="requested_days" name="requested_days" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Number of Days Outstanding</label>
                                        <input id="outstanding_days" name="outstanding_days" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
