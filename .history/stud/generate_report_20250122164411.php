...
if (isset($_POST['generate_report'])) {
    ...
    $pdf->Cell(0, 10, 'Calendar Report', 0, 1, 'C');

    // Get the selected month or default to current month
    $selectedMonth = isset($_GET['month']) ? intval($_GET['month']) : date('n');

    // Display the updated calendar as HTML
    $calendarHtml = draw_calendar($selectedMonth, 2025, $calendarEvents);

    // Output the calendar HTML into PDF
