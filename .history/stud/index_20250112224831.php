...
<body>
    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            ...
            // Check if there is a latest leave record
            ...
            <div class="row pb-10">
                ...
                while ($row = mysqli_fetch_array($query)) {
                    // Determine the value to display for "Available Days"
                    $availableDays = ($row['RegRemarks'] == 1) ? $row['DaysOutstand'] : $row['available_day'];
                ?>
