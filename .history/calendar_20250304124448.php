...
<div class="card-box height-100-p d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="text-center">
        <form class="d-flex align-items-center justify-content-center">
            <button type="button" data-month="<?= $previousMonth ?>" class="btn btn-outline-primary mx-2 change-month">&lt;</button>
            <h5 class="mb-0"><?= date("F", mktime(0, 0, 0, $currentMonth, 1, $currentYear)) ?> <?= $currentYear ?></h5>
            <button type="button" data-month="<?= $nextMonth ?>" class="btn btn-outline-primary mx-2 change-month">&gt;</button>
        </form>
    </div>
