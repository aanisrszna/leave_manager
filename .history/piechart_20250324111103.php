...
$leaveCountsAnnual = [];
$leaveCountsMedical = [];
// Display Annual Leave Count
echo "<h3>Annual Leave Count</h3>";
foreach ($resultsAnnual as $row) {
    echo "Employee: " . $row['FirstName'] . " - Leave Count: " . $row['leave_count'] . "<br>";
}

// Display Medical Leave Count
echo "<h3>Medical Leave Count</h3>";
foreach ($resultsMedical as $row) {
    echo "Employee: " . $row['FirstName'] . " - Leave Count: " . $row['leave_count'] . "<br>";
}

// Print full arrays for debugging
echo "<h3>Annual Leave Data</h3>";
echo "<pre>";
print_r($resultsAnnual);
echo "</pre>";

echo "<h3>Medical Leave Data</h3>";
echo "<pre>";
