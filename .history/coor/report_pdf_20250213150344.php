...
$hod_sign = !empty($row['HodSign']) ? '../signatures/' . $row['HodSign'] : 'No Signature';
$reg_sign = !empty($row['RegSign']) ? '../signatures/' . $row['RegSign'] : 'No Signature';

$hod_date = !empty($row['HodDate']) ? date('d-M-Y', strtotime($row['HodDate'])) : '__________';
$reg_date = !empty($row['RegDate']) ? date('d-M-Y', strtotime($row['RegDate'])) : '__________';
