...
class MYPDF extends TCPDF {
    public function Header() {
        $this->Image('../vendors/images/riverraven.png', 160, 10, 30); // Logo
        
        $this->SetFont('helvetica', 'B', 14);
        $this->Cell(0, 10, 'Leave Application Form', 0, 1, 'L'); // Move to next line
    
        $this->SetFont('helvetica', 'I', 10);
        $this->Cell(0, 5, '(This form must be COMPLETED with all details before submission)', 0, 1, 'L'); // Move to next line
    
        $this->Ln(10); // Move cursor down further
    }
