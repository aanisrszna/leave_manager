...
// Example values (Retrieve these from your database)
$hod_approval = "Approved"; // or "Rejected"
$director_approval = "Rejected"; // or "Approved"
$hod_signature = "hod_sign.png"; // Path to HOD signature image
$director_signature = "director_sign.png"; // Path to Director signature image
...
// Insert HOD Signature if approved
$html .= ($hod_approval == "Approved") 
    ? '<img src="'.$hod_signature.'" width="100" height="50">' 
...
// Insert Director Signature if approved
$html .= ($director_approval == "Approved") 
    ? '<img src="'.$director_signature.'" width="100" height="50">' 
    : '__________________________________';
...
$html .= <<<EOD
    ...
    <tr>
        <td>[" . ($hod_approval == 'Approved' ? '✓' : ' ') . "] Approved</td>
        <td>[" . ($hod_approval == 'Rejected' ? '✓' : ' ') . "] Rejected</td>
        <td>[" . ($director_approval == 'Approved' ? '✓' : ' ') . "] Approved</td>
        <td>[" . ($director_approval == 'Rejected' ? '✓' : ' ') . "] Rejected</td>
    </tr>
</table>
EOD;
...
// Output the PDF (Ensure there's no output before this line)
