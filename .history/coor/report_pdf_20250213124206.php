...
class MYPDF extends TCPDF {
    ...
    // Constructor to accept variables
    ...
    public function Header() {
        ...
        $this->Cell(0, 8, "Full Name: " . $this->fullname, 0, 1, 'L');
        $this->Cell(0, 8, "Position: " . $this->staff_position, 0, 1, 'L');
        $this->Ln(5);
    }
...
// Create PDF instance with correct variables
