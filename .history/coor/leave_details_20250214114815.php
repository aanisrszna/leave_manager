...
if (isset($_POST['update'])) { 
    ...
    if ($status === '2') { // Leave rejected
        ...
        $result = mysqli_query($conn, "
            ...
            JOIN employee_leave AS el ON tl.empid = el.emp_id AND lt.id = el.leave_type_id
            SET 
                tl.HodRemarks = '$status',
                tl.HodSign = '$signature',
                tl.HodDate = '$admremarkdate',
							...
							<div class="col-md-12">
								...
								<div class="avatar mr-2 flex-shrink-0">
									<?php if (!empty($result->proof)) { ?>
										<img src="<?php echo '../proofs/' . htmlentities($result->proof); ?>" style="max-width: 100%; height: auto;" alt="Proof Picture">
									<?php } else { ?>
