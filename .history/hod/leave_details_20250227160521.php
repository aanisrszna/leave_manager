...
if (isset($_POST['update'])) {
    ...
    if ($status === '2') { // Leave Rejected
        ...
        send_email($staffEmail, $subject_reject, $message_reject);
        ...
        if ($result) {
            ...
            $subject_approve = "Leave Approval Notification - $staffName";
            $message_approve = "
                <p>Dear Director,</p>
            ...
            send_email($directorEmail, $subject_approve, $message_approve);
