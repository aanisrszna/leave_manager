...
document.addEventListener("DOMContentLoaded", function() {
    document.body.addEventListener("click", function(event) {
        if (event.target.classList.contains("change-month")) {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    // Update only the calendar content
                    document.getElementById("calendar-content").innerHTML = responseHTML.querySelector("#calendar-content").innerHTML;

                    // Update the displayed month
                    document.getElementById("current-month").innerHTML = responseHTML.querySelector("#current-month").innerHTML;
                }
            };
            xhr.send();
        }
