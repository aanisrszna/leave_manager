...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['apply'])) {
    ...
    // Fetch the role from tblemployees table
            ...
            if ($role === 'Manager') {
                ...
                if ($director_result->num_rows > 0) {
                    while ($director = $director_result->fetch_assoc()) {
                        ...
                        $message = "Dear Director,\n\nA manager has applied for leave:\n\n" .
                            "Employee ID: $empid\n" .
                            "Leave Type: $leave_type\n" .
                            "From: $date_from\n" .
                            "To: $date_to\n" .
                            "Reason: $reason\n\n" .
                            "Please review and take necessary action.\n\nBest regards,\nE-Leave Manager System";

                        $headers = "From: anis@riverraven.com.my\r\n" .
                                   "Reply-To: anis@riverraven.com.my\r\n" .
                                   "Content-Type: text/plain; charset=UTF-8\r\n";

                        // Send email
                        mail($director_email, $subject, $message, $headers);
                    }
                }
            }
