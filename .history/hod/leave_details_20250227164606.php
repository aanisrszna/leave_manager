...
if (isset($_POST['update'])) {
    ...
    $sql = "SELECT emp.fullname, emp.EmailId, leave_tbl.LeaveType, leave_tbl.FromDate, leave_tbl.ToDate, 
                   leave_tbl.NoOfDays, leave_tbl.Description 
    ...
    if ($status === '2') { // Leave Rejected
        ...
        $message = "<p>Dear $emp_name,</p><p>Your leave application has been <b>Rejected</b> by the HOD.</p>";
        ...
        $message = "<p>Dear Director,</p><p>$emp_name has applied for leave and it has been <b>Approved</b> by the HOD.</p>";
