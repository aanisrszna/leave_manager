...
<!-- CSS Styling -->
<style>
    h5 { font-size: 1rem; font-weight: bold; text-align: center; margin-bottom: 10px; }
    .calendar-container { width: 100%; }
    .calendar-row { display: flex; width: 100%; }
    .calendar-cell { flex: 1; padding: 13px; text-align: center; border: 1px solid #ddd; margin: 2px; position: relative; }
    .calendar-cell:hover::after {
        content: attr(data-event);
        position: absolute; bottom: 100%; left: 50%;
        transform: translateX(-50%); background: rgba(0, 0, 0, 0.75);
        color: white; padding: 5px 10px; border-radius: 5px; white-space: nowrap;
    }
</style>
