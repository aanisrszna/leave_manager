...
echo '<div class="text-center">
    <button class="btn btn-outline-primary mx-2 change-month" data-month="'.$previousMonth.'">&lt;</button>
    <h5 class="mb-0">'.date("F", mktime(0, 0, 0, $currentMonth, 1, $currentYear)).' '.$currentYear.'</h5>
    <button class="btn btn-outline-primary mx-2 change-month" data-month="'.$nextMonth.'">&gt;</button>
</div><br>';
