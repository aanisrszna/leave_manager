			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name"><?php echo $row['FirstName']; ?><br><h6 style="font-size: 12px; color: white; margin-right: 10px; margin-top: 5px;"><i style="margin-right: 2px;" class="fa fa-circle text-light-green"></i> <?php echo $row['Status']; ?></h6></span>
									...
									<ul>
										...
										<li>
											<a href="chat.php?sender=<?php echo $session_id; ?>&receiver=<?php echo $row['emp_id']; ?>">
												<img src="<?php echo (!empty($row['location'])) ? '../uploads/'.$row['location'] : '../uploads/NO-IMAGE-AVAILABLE.jpg'; ?>" alt="">
												<h3 class="clearfix"><?php echo substr($row['FirstName'], 0, 15); ?></h3>
												<p>
                                                 <?php
