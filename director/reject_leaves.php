    ...
    <div class="pd-ltr-20">
        <div class="page-header">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="title">
                        <h4>Rejected Leave Applications</h4>
                    </div>
        ...
        <div class="card-box mb-30">
            <div class="pd-20 d-flex justify-content-between align-items-center">
                ...
                <a href="app.php" class="btn btn-outline-secondary btn-sm">← Back to All Leaves</a>
            </div>
                ...
                <table class="data-table table stripe hover nowrap">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT 
                                ...
                                FROM tblleave
                                JOIN tblemployees 
                                    ON tblleave.empid = tblemployees.emp_id
                                WHERE tblleave.RegRemarks = 2
                        ...
                        if ($results) {
                            foreach ($results as $row) {
                                ...
                                $orderDate = $row->FromDate ? date('Ymd', strtotime($row->FromDate)) : '';
                                ?>
                                <tr>
                                    <td class="table-plus">
                                        <div class="txt">
