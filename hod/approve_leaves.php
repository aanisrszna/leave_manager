	...
	<div class="main-container">
		<div class="pd-ltr-20">
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">HOD Approved Leaves</li>
							</ol>
						</nav>
					</div>
				</div> 
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h2 class="text-blue h4">LEAVE APPLICATIONS APPROVED BY HOD</h2>
				</div>
				<div class="pb-20">
